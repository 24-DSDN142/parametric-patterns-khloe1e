...
function my_symbol(){
    square(pxsize*8, pxsize*6, pxsize, pxsize);
    fill(255, 215, 223);
    square(pxsize*9, pxsize*5, pxsize, pxsize);
    fill(255, 215, 223);
    rect(pxsize*10, pxsize*4, pxsize*2, pxsize);
    fill(255, 215, 223)
    square(pxsize*12, pxsize*5, pxsize, pxsize);
    fill(255, 215, 223);
    rect(pxsize*13, pxsize*6, pxsize, pxsize*2);
    fill(255, 215, 223);
    square(pxsize*12, pxsize*8, pxsize, pxsize);
    fill(255, 215, 223);
    square(pxsize*11, pxsize*9, pxsize, pxsize);
    fill(255, 215, 223);
    square(pxsize*10, pxsize*10, pxsize, pxsize);
    fill(255, 215, 223);
    square(pxsize*9, pxsize*11, pxsize, pxsize);
    fill(255, 215, 223);
    square(pxsize*8, pxsize*12, pxsize, pxsize);
    fill(255, 215, 223);
    square(pxsize*7, pxsize*11, pxsize, pxsize);
    fill(255, 215, 223);
    square(pxsize*6, pxsize*10, pxsize, pxsize);
    fill(255, 215, 223);
